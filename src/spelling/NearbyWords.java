...
public class NearbyWords implements SpellingSuggest {
	...
	public List<String> suggestions(String word, int numSuggestions) {
		...
		while (!queue.isEmpty() && retList.size() < numSuggestions && searchCounter < THRESHOLD) {
			searchCounter++;
			String currentWord = queue.remove();
			if (currentWord != word) retList.add(currentWord);
			List<String> words = distanceOne(currentWord, true);
			for (String w : words) {
		...
		if (searchCounter == THRESHOLD) System.out.println("Threashold reached");
		return retList;
